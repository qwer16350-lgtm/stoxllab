...
def test_one_shot_send_default_blocked_report() -> None:
    ...
    assert_true(report["execute_flag_present"] is False, "Execute flag default false")
    assert_true(report["execution_gate_conditions_met"] is False, "Execution gate default false")
    assert_true(report["actual_execution_adapter"] == "none", "No adapter by default")
    assert_true(report["phase39b_actual_execution_mode_available"] is True, "Execution mode available")
...
def test_one_shot_send_phase39b_ready_gate_no_send() -> None:
    ...
    assert_true(report["execute_flag_present"] is False, "Execute flag false")
    assert_true(report["execution_gate_conditions_met"] is False, "Execution gate false")
    assert_true(report["actual_execution_adapter"] == "none", "Ready gate has no adapter")
    ...
    assert_true(report["ready_for_actual_private_test_send"] is False, "No actual execution readiness")
